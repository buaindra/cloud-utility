...
setuptools.setup(
    ...
    url="https://github.com/buaindra/cloud-utility",
    project_urls={
        "Bug Tracker": "https://github.com/buaindra/cloud-utility/issues",
    },
    classifiers=[
    ...
    py_modules=["cloud_utility"],           # Name of the python package
